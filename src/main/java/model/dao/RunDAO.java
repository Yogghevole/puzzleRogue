...
public class RunDAO {
    ...
    // Update the save() method SQL to match schema
    public void save(Run run) {
        ...
        try (Connection conn = dbManager.getConnection();
            ...
            // Get generated ID if this was an insert
            if (run.getId() == null) {
    ...
    // Update saveLevelState() to match schema
    ...
    // Update findActiveRunByUser() query to match schema
        ...
        try (Connection conn = dbManager.getConnection();
            ...
            while (rs.next()) {
                ...
                try {
                    ...
                    // Map level state if not already set
